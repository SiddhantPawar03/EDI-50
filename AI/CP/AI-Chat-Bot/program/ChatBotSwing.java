...
public class ChatBotSwing extends JFrame implements KeyListener
{
	...
	String chatBot[][] = {
			...
			{"I was developed by team of smart people named Mandar, Maruti, Pavan, Siddhant under the guidance of GDB sir :)"},
			//Name
		...
		if(arg0.getKeyCode() == KeyEvent.VK_ENTER)
		{
			...
			*/
			...
			if( response==1 )
			{
				...
				addText("\n--> College Mitra:\t " + chatBot[ chatBot.length-1 ][r] );
			}
		}
	}
